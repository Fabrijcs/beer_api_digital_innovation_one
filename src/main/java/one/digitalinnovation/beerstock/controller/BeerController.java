...
@RestController // Mude de @Service para @RestController
...
public class BeerController implements BeerControllerDocs {
    ...
    @PostMapping // Faltava este método para cumprir o contrato da Interface
    ...
    @PatchMapping("/{id}/decrement") // Adicionado para suportar o novo teste
